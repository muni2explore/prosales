			...
			function formSubmit(){
				...
				if(!$('label.'+opt.invalidClass+',label.'+opt.emptyClass,form).length){					
					$.ajax({
						...
						,data:{
							department:getValue($('label.department select'))
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 23.818
  LoadShardBlock: 86.165 (3)
  PetaboxLoader3.datanode: 843.265 (5)
  load_resource: 907.223 (2)
  PetaboxLoader3.resolve: 83.365
*/